...
predictions = lines[0]
predicted_responses = list(map(lambda x: x['response'], predictions))
predicted_responses = list(map(lambda x: x.replace('<|endoftext|>', ''), predicted_responses))
